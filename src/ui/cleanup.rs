...
fn request_body(model: &str, text: &str) -> String {
    let mut request = serde_json::json!({
        ...
        // Tidying is not a creative task, and a warm model invents wording.
        "temperature": 0.0,
        "stream": false,
        // Enough for the transcript to come back longer than it went in,
        // without letting a runaway reply cost twenty seconds.
        "max_tokens": 1024,
